...
export default function Welcome(){
    ...
    return(
        ...
        <section id="home" className="bg-[#09101a] h-screen lg:flex lg:flex-col lg:items-center">
            <div className=" p-2 lg:w-[700px] lg:space-y-7 2xl:w-[1000px]">        
                <h1 className="text-white text-[45px] mt-24 font-black">HI, I'M YASH! Creative</h1>    
                ...
                <div className="mt-8 text-[#a2a2a2] leading-7 font-bold  lg:w-[700px]">
                ...
                <button className="bg-[#55e6a5] w-40 text-black p-5 flex flex-col items-center mt-10 font-extrabold hover:bg-[#141c27] hover:text-white transition-all duration-300 ease-in-out">
                Download CV
            </button>
            </div>
        </section>
