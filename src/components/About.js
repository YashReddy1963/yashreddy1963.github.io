...
export default function About(){
    ...
    return(
        ...
        <section id="about" className="bg-[#02050a] h-full lg:flex lg:items-center lg:flex-col lg:h-screen lg:mb-0">
            <div className='flex flex-col items-center lg:flex-row lg:w-[700px] lg:items-center 2xl:w-[1200px] 2xl:mt-14'>
                <div className="flex flex-col items-center m-3 2xl:m-0">
                    <div className="text-[#55e6a5] mt-10 lg:mt-16 font-bold text-3xl w-full 2xl:text-7xl ">
                        ABOUT ME
                    </div>
                    <div className='2xl:mt-24 2xl:w-[700px] space-y-14'>
